-- =============================================
-- ROTATION / PLACEMENT PROPS CLIENT — v3.2
-- =============================================
...
RegisterCommand('placeprop', function(_, args)
    PropManager:Place(args[1] or Config.Rotation.DefaultPropName)
end, false)

RegisterCommand('deleteprop',    function() PropManager:Delete() end, false)
RegisterCommand('deletenearby',  function() PropManager:DeleteNearby() end, false)
